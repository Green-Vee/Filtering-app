...
// Add or remove item from the card
...
// Filter products by search boxs and search input
function filterProducts() {
  // Get term
  const searchTerm = searchInput.value.trim().toLowerCase();

  // Get Checked categories
  const checkedCategories = Array.from(checkBoxs)
  ...
  productElements.forEach((productElement, index) => {
    ...
    // Check to see product matches the search or the checked categories
